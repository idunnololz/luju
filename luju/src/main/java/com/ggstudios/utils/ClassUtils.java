...
public class ClassUtils {
    public static Interface isCyclic(List<Interface> interfaces, Map<Class, Integer> interfaceToIndex) {
    ...
    private static boolean isCyclicUtil(Map<Class, Integer> interfaceToIndex, Interface interface_, int v, boolean[] visited, boolean[] recStack) {
        if (!visited[v]) {
            ...
            for(Class c : interface_.getInterfaces()) {
